...
router.post('/', async (req, res) => {
    try {
        const { nombre, categoria, precio, tiempo_estimado, disponible, descripcion, usa_inventario, stock_actual, stock_minimo, estado_inventario } = req.body;
        ...
        const query = `
            INSERT INTO menu_items(
                ...
                usa_inventario, stock_actual, stock_minimo, estado_inventario
            )
    ...
    try {
        ...
        const query = `
            ...
            SET nombre = $1, categoria = $2, precio = $3, tiempo_estimado = $4, 
                ...
                stock_actual = $8, stock_minimo = $9, estado_inventario = $10
            WHERE id = $11
        `;
